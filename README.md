...
(5) Open in the browser: `http://localhost/neuron/neuron_en.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
...
(3) Open in the browser: `http://localhost/neuron/build/adapted-from-phet/neuron_en_adapted-from-phet.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
...
### License
See the <a href="https://github.com/phetsims/neuron/blob/master/LICENSE" target="_blank">LICENSE</a>
