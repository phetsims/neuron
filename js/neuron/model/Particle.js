...
Particle
implements
IMovable, IFadable, IViewableParticle
{
  ...
  final
  double
  DEFAULT_PARTICLE_RADIUS = 0.75;  // In nanometers.
  ...
  protected
  ArrayList < IParticleListener > listeners = new ArrayList < IParticleListener > ();
  ...
  private
  MotionStrategy
  motionStrategy = new StillnessMotionStrategy();
  ...
  private
  FadeStrategy
  fadeStrategy = new NullFadeStrategy();
   ...
   */
  public
  void setFadeStrategy( FadeStrategy
  fadeStrategy
)
  {
  ...
  public
  void setMotionStrategy( MotionStrategy
  motionStrategy
)
  {
   ...
   */
  public
  void addListener( IParticleListener
  listener
)
  {
   ...
   */
  public
  void removeListener( IParticleListener
  listener
)
  {
