...
define( require => {
  ...
  // modules
  const DualGateChannelTraversalMotionStrategy = require( 'NEURON/neuron/model/DualGateChannelTraversalMotionStrategy' );
  const GatedChannel = require( 'NEURON/neuron/model/GatedChannel' );
