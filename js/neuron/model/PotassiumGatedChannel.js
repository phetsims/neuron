...
GatedChannel
{
  ...
  final
  double
  MIN_INTER_CAPTURE_TIME = 0.00005; // In seconds of sim time.
  private
  static
  final
  double
  MAX_INTER_CAPTURE_TIME = 0.00020; // In seconds of sim time.
  ...
  final
  double
  MAX_STAGGER_DELAY = NeuronDefaults.MIN_ACTION_POTENTIAL_CLOCK_DT * 10; // In seconds of sim time.
  ...
  public
  PotassiumGatedChannel( IParticleCapture
...
)
  {
    ...
    double
    openness = 1 - Math.pow( normalizedConductance - 1, 2 );
