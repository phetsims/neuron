...
package
edu.colorado.phet.neuron.controlpanel;
...
ControlPanel
{
  ...
  private
  JCheckBox
  chartControlCheckbox;
  private
  JCheckBox
  showChargesCheckBox;
  private
  JCheckBox
  showConcentrationReadoutCheckBox;
   ...
   */
  public
  AxonCrossSectionControlPanel( PiccoloModule
  module, Frame
  parentFrame, final
  NeuronModel
  model
)
  {
    ...
    int
    minimumWidth = NeuronResources.getInt( "int.minControlPanelWidth", 215 );
    ...
    // Add the check boxes.
    JPanel
    checkBoxPanel = new VerticalLayoutPanel();
    BevelBorder
    baseBorder = (BevelBorder)
    BorderFactory.createRaisedBevelBorder();
    TitledBorder
    titledBorder = BorderFactory.createTitledBorder( baseBorder,
  ...
  private
  JPanel
  createVerticalSpacingPanel( int
  space
)
  {
    JPanel
