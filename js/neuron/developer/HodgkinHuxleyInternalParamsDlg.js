...
PaintImmediateDialog
{
  ...
  private
  ParameterEntry
  membraneCapacitanceParmEntry = new ParameterEntry( "Membrane Capacitance:", "mF" );
  private
  ParameterEntry
  gNaParmEntry = new ParameterEntry( "Sodium Chan Conductance:", "S" );
  private
  ParameterEntry
  gKParmEntry = new ParameterEntry( "Potassium Chan Conductance:", "S" );
  private
  ParameterEntry
  gLParmEntry = new ParameterEntry( "Leak Chan Conductance:", "S" );
  private
  JButton
  readValuesButton = new JButton( "Read Values" );
  private
  JButton
  writeValuesButton = new JButton( "Write Values" );

  public
  HodgkinHuxleyInternalParamsDlg( Frame
  frame, IHodgkinHuxleyModel
  hhModel
)
  {
    super( frame );
