...
PNode
{
   ...
   */
  public
  GrippyIndentNode( double
  diameter, Color
  baseColor
)
  {
    Color
    baseDarkerColor = ColorUtils.darkerColor( baseColor, 0.9 );
    Color
    translucentDarkerColor = new Color( baseDarkerColor.getRed(), baseDarkerColor.getGreen(),
      baseDarkerColor.getBlue(), baseColor.getAlpha() );
    Color
    baseLighterColor = ColorUtils.brighterColor( baseColor, 0.9 );
    Color
    translucentBrighterColor = new Color( baseLighterColor.getRed(), baseLighterColor.getGreen(),
