...
import edu.
colorado.phet.common.phetcommon.application.PhetApplicationConfig;
import edu.
colorado.phet.common.phetcommon.application.PhetApplicationLauncher;
import edu.
colorado.phet.common.phetcommon.view.PhetFrame;
import edu.
colorado.phet.common.phetcommon.view.menu.OptionsMenu;
import edu.
colorado.phet.common.piccolophet.PiccoloPhetApplication;
import edu.
colorado.phet.neuron.developer.HodgkinHuxleyInternalDynamicsDlg;
import edu.
colorado.phet.neuron.developer.HodgkinHuxleyInternalParamsDlg;
import edu.
colorado.phet.neuron.module.NeuronModule;
...
PiccoloPhetApplication
{
  ...
  hhInternalDynamicsDlg = null;
  private
  JCheckBoxMenuItem
  hhModelDynamicsControl;
  private
  HodgkinHuxleyInternalParamsDlg
  hhInternalParamsDlg = null;
  private
  JCheckBoxMenuItem
  hhModelParamsControl;
   ...
   */
  public
  NeuronApplication( PhetApplicationConfig
  config
)
  {
    super( config );
...
)
  {
    ...
    // Developer menu
    JMenu
    developerMenu = frame.getDeveloperMenu();
  ...
  private
  void setHHModelDynamicsWindowVisible( boolean
  isVisible
)
  {
  ...
  private
  void setHHModelParamsWindowVisible( boolean
  isVisible
)
  {
